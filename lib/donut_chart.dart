...
class DonutChart2 extends StatelessWidget {
  ...
  const DonutChart2({
    ...
    this.innerRadiusRatio = 0.6, // Relación entre radio interno y externo (controla tamaño del hueco)
...
class DonutChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < data.length; i++) {
      ...
      if (showPercentageLabels && sweepAngle > 0.3) { // Solo mostrar si el segmento es lo suficientemente grande
