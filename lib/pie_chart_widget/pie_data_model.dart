...
enum LegendTogglePosition { top, bottom }
...
class PieChartConfig {
  ...
  final LegendTogglePosition legendTogglePosition;
  ...
  PieChartConfig({
    ...
    this.legendTogglePosition = LegendTogglePosition.top,
    this.showBorders = true,
    this.optionText = "Show Legend",
