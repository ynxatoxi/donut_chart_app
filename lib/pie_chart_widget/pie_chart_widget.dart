  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (widget.config.showLegendToggle &&
            widget.config.legendTogglePosition == LegendTogglePosition.top)
          Padding(
        ...
        if (widget.config.showLegendToggle &&
            widget.config.legendTogglePosition == LegendTogglePosition.bottom)
          Padding(
          ...
          child: Row(
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: segment.color,
                  shape: widget.config.legendShape == LegendShape.circle
                      ? BoxShape.circle
                      : BoxShape.rectangle,
                  borderRadius:
